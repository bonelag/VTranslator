...
def yearsummary(self, basel: QHBoxLayout):
    ...
    with open(r"VTranslator\htmlcode/yearsummary/yearsummary.value.js", "w", encoding="utf8") as ff2:
        ff2.write(
            r"""
...
""".format(
    ...
    link = os.path.abspath(r"VTranslator\htmlcode/yearsummary/yearsummary.html")
    try:
