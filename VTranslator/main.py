...
def loadmainui(startwithgameuid):
    import gobject
    from VTranslator import BASEOBJECT
...
def checkintegrity():
    ...
    dllshared = [
        "VHook/" + ("VHost32.dll", "VHost64.dll")[runtime_bit_64],
...
def parsellmapi(result):
    ...
    # vtranslator://llmapi/base64?data=……
    # vtranslator://llmapi/info?……
    # name/id [可空]
    # uid [可空]
    # apiUrl/baseUrl 必选
    # apiKey 必选
...
def ifhasllmapi(_):
    ...
    gobject.isRunningMutex = NativeUtils.SimpleCreateMutex("V_IS_RUNNING_MUTEX")
